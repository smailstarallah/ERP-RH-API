...
public class PointageController {
    ...
    public PointageController(PointageService pointageService, ProjectService projectService, PlanningTravailService planningTravailService) {
